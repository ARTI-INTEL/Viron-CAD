...
(function () {
  ...
  function renderDotCalls(calls) {
    ...
    el.innerHTML = calls.map(function (c) {
      ...
      return '<div class="tbl-row">' +
        ...
        '<button class="dot-notes-btn" data-id="' + c.id + '" style="background:rgba(255,255,255,0.08);color:#aaa;border:0.0625rem solid rgba(255,255,255,0.12);height:1.75rem;padding:0 0.5rem;border-radius:0.5rem;font-family:Inter,sans-serif;font-size:0.7rem;font-weight:700;cursor:pointer;white-space:nowrap;">📋</button>' +
        attachBtn +
  ...
  document.getElementById('dot-btn-sup-view-reports').addEventListener('click', function () {
    ...
    var bcEl = document.getElementById('dot-sup-bodycam-list');
    if (bcEl) {
